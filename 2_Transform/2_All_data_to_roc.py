...
df['roc_open_ibova'] = ta.roc(df['open_ibova'], length=1, scalar=None, talib=None, offset=None)
df['roc_open_oil'] = ta.roc(df['open_oil'], length=1, scalar=None, talib=None, offset=None)
df['roc_open_usd'] = ta.roc(df['open_usd'], length=1, scalar=None, talib=None, offset=None)
df['roc_open_abev'] = ta.roc(df['open_abev'], length=1, scalar=None, talib=None, offset=None)
df['roc_open_jbs'] = ta.roc(df['open_jbs'], length=1, scalar=None, talib=None, offset=None)
df['roc_open_petr4'] = ta.roc(df['open_petr4'], length=1, scalar=None, talib=None, offset=None)
df['roc_open_vale'] = ta.roc(df['open_vale'], length=1, scalar=None, talib=None, offset=None)

# Selecionando colunas desejadas e resetando o index
df = df.reset_index()
df = df[['date','roc_open_ibova','roc_open_oil','roc_open_usd','roc_open_abev','roc_open_jbs','roc_open_petr4','roc_open_vale']]
df = df.dropna()
